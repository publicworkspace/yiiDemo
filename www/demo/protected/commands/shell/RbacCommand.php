    ...
    **/
    public function run($args)
    {
        ...
        if(!strncasecmp(trim(fgets(STDIN)),'y',1))
        {
            ...
            $this->_authManager->createOperation("createIssue","create te a new issue");
            $this->_authManager->createOperation("readIssue","read issue information");
            $this->_authManager->createOperation("updateIssue","update te issue information");
            $this->_authManager->createOperation("deleteIssue","delete te an issue from a project");
